...
if __name__ == "__main__":
    ...
    for merger_index in tqdm(merger_indices):
        ...
        DescendantID_mergers.append(dID)
        remnant_snap_mergers.append(remnant_snap)
    ...
    DescendantID_mergers = np.array(DescendantID_mergers)
    remnant_snap_mergers = np.array(remnant_snap_mergers)
    ...
    np.savez(save_file_name,
         ...
         DescendantID=DescendantID_mergers,
         remnant_snap=remnant_snap_mergers)
